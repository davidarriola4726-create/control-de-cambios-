      ...
      <div className="bg-white rounded-xl border border-slate-200 p-3.5 sm:p-4 shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            {isAdmin && (
              <div className="flex items-center gap-1 bg-slate-100 px-2.5 py-1 rounded-lg border border-slate-200 text-xs">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-3 pt-2.5 border-t border-slate-100 text-xs">
          <div className="bg-slate-50 p-2 sm:p-2.5 rounded-lg border border-slate-100">
            <span className="text-slate-400 font-bold uppercase text-[9px] block">
              Total Reclamaciones
            </span>
            <strong className="text-lg sm:text-xl font-black text-slate-900 mt-0.5 block">
              {totalClaimsCount}
            </strong>
          </div>
          ...
          <div className="bg-slate-50 p-2 sm:p-2.5 rounded-lg border border-slate-100">
            ...
            <strong className="text-lg sm:text-xl font-black text-emerald-700 mt-0.5 block">
              {totalUnitsCount}
            </strong>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3.5">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-3.5 sm:p-4 shadow-xs">
          <div className="pb-2 mb-3 border-b border-slate-100">
            ...
            <p className="text-[11px] text-slate-500">Ranking por volumen de unidades cambiadas</p>
          </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-3.5 sm:p-4 shadow-xs">
          <div className="pb-2 mb-3 border-b border-slate-100">
            ...
            <p className="text-[11px] text-slate-500">Distribución porcentual de causas registradas</p>
          </div>
